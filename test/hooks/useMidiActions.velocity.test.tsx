...
const makeMidiConfiguration = (overrides: Partial<MidiConfiguration> = {}): MidiConfiguration => ({
  inputEnabled: true,
  outputEnabled: true,
  inputId: 'in',
  outputId: 'out',
...
describe('useMidiActions velocity handling', () => {
  it('scales YM preview volume from incoming velocity when ignoreInputVolume is false', async () => {
    ...
    const midiConfigurationRef = {
      current: makeMidiConfiguration({ ignoreInputVolume: false, ignoreOutputVolume: true }),
  ...
  it('keeps YM preview at full volume when ignoreInputVolume is true', async () => {
    ...
    const midiConfigurationRef = {
      current: makeMidiConfiguration({ ignoreInputVolume: true, ignoreOutputVolume: true }),
    } as React.RefObject<MidiConfiguration | null>;
  ...
  it('forwards raw MIDI velocity to MIDI out when ignoreOutputVolume is false', async () => {
    ...
    const midiConfigurationRef = {
      current: makeMidiConfiguration({ ignoreInputVolume: true, ignoreOutputVolume: false }),
    } as React.RefObject<MidiConfiguration | null>;
